...
HD_PWD='C:/Users/Simone Ragoni/alice/CtpReadout/ctp_readout2/ctp_readout2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_tc_statemachine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_tc_statemachine.tcl
